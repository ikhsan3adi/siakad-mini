...
class AuthJWT extends ShieldAuthJWT
{
     ...
     * Name of Cookie
     * --------------------------------------------------------------------
     * The name of Cookie that the Authorization token should be found.
     */
    public string $cookieName = 'jwt_token';
     ...
     */
    public int $recordLoginAttempt = Auth::RECORD_LOGIN_ATTEMPT_NONE;
}
